...
const deviceCatalog = [
    ...
    { name: 'Laptop Gamer Asus', category: 'Computadoras' },
    { name: 'Laptop HP', category: 'Computadoras' },
    { name: 'PC Gamer Completa', category: 'Computadoras' },
    { name: 'Desktop Empresarial', category: 'Computadoras' },
    { name: 'Procesador Intel Core i7', category: 'Componentes' },
    { name: 'Procesador AMD Ryzen 7', category: 'Componentes' },
    { name: 'Tarjeta Gráfica RTX 4070', category: 'Componentes' },
    { name: 'Tarjeta Madre ASUS', category: 'Componentes' },
